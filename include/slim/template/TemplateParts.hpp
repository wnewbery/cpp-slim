...
namespace slim
{
    ...
    namespace tpl
    {
        ...
        /**A script expression block to evaulate, but does not output anything.*/
        class TemplateCodeBlock : public TemplatePart
        {
        public:
            TemplateCodeBlock(std::unique_ptr<Expression> &&expression);
            ~TemplateCodeBlock();
